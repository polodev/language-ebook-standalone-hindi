...
- ca94e57: expands all 60 Foundation chapter seed files into substantive content. Master outline/status still describes outline-only work, so status prose must not be treated as an inventory audit.
- 7e107c9: changes Foundation/Intermediate layouts, extends Advanced rendering and adds late Intermediate images plus small Advanced corrections. Rendering logic is actively evolving.
- 4fb61dd: book 12 roster, 7,020 targets / 234 chapters / 25 words + 5 expressions per chapter.
- 0bd85ad: removes antonyms from compact vocabulary editions only.
- 5533d9f and b612d73: Intermediate chapter batches 41–50 and 31–40.

Book 9: Foundation, 60 chapters, A1–A2–early B1 intent, 20 sentences in normal chapters; ten builder-only exceptions in the old contract. Book 10: Intermediate, 60 chapters, B1–B2–early C1 intent, similar normal/builder split. Book 11: Advanced, 60 chapters, B2–C1–C2 intent, revised contract requires 15 sentences, 10 vocabulary entries, two readings and six speaking tasks EVERY chapter, with builders as extra practice. Its older image guide still describes a builder exemption: the newer chapter instruction wins. Book 12 at the frozen commit is a roster, not completed vocabulary teaching content.
